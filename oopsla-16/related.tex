...
Other tools such as DJIT+ \cite{djit} and FastTrack \cite{fasttrack} opt for the precise Happens-Before analysis,
which produces no false positives but is prone to more false negatives as shown in \sect{\ref{sec:overview-dr}}.
FastTrack, the most recent development in this approach,
optimizes the representation of variable write vector clocks for performance,
...
Hence, we implement precise HB as defined by DJIT+.
