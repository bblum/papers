...
1.5x as many bugs and verified 4.3x as many tests compared to the best prior model checking approach. %stateless model checking without data-race preemption points.
