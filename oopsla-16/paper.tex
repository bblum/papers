...
\usepackage{graphicx}
\usepackage{courier} % TODO: remove this? and get nicer fonts?
\usepackage{amsthm}
...
% TODO: remove all changebars before submission
...
1.8x as many bugs and verified 4.3x as many tests compared to stateless model checking without data-race preemption points.
