...
1.5x as many bugs and verified 4.3x as many tests compared to \revision{prior model checking approaches}. %stateless model checking without data-race preemption points.
