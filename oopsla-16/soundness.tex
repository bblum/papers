...
%
% TODO: Aaargh, can't think of how to actually justify this.
...
We also assume the Limited HB definition for the data-race analysis, leaving the case for precise HB to future work.
}
...
\revisionx{One way to avoid such collisions would be to use a hacked allocator during testing which never recycles memory, but this could unacceptably impact performance in {\tt malloc}-heavy tests.}

\begin{figure}[t]
	\small
\begin{tabular}{rll}
	% TODO: Can cut struct defns for space.
...
% TODO CAMREADY: Cite the tech report proofs, which I think call out the use of limited HB in the proof more explicitly.
}
