...
% On the other hand, techniques such as ICB assume all state spaces will be too big, and optimize the search to uncover bugs more quickly, but at the expense of / by sacrificing the ability to complete a total verification quickly when possible.
...
\quicksand~\revision{identifies these pitfalls in advance using state space estimation \cite{estimation},
