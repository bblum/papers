...
\revision{It can optionally replace DPOR with Iterative Context Bounding (ICB) \cite{chess-icb},
for which it uses Bounded Partial Order Reduction (BPOR) \cite{bpor} for a similar sound reduction,
...
The {\tt without\_\allowbreak{}function} directive \revision{serves as}~the dual of {\tt within\_function}, indicating a blacklist.
