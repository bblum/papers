...
\begin{figure}[t]
	...
	\includegraphics[width=0.48\textwidth]{dowefindbugsfaster-squashed.pdf} \\
		% TODO CAMREADY "as a function of elapsed"
		(a) Bugs found by elapsed CPU time. Overall,
		% TODO CAMREADY "a more resource-fair"
		a more direct comparison than (b),
...
with a 10 core allocation, it outperforms SSS-MC for any fixed budget of wall-clock time.}
...
%% TODO CAMREADY
%% We found the maximum area between any two QS-DR curves to be
...
% TODO: Fix to be ICB not DPOR.
On 129 tests, SSS-MC-DPOR timed out after 10 hours with no bugs found.
...
Among QS-DR's verified tests, 36 contained no data-race candidates whatsoever,
...
\begin{figure}[t]
	\includegraphics[width=0.48\textwidth]{totalverifs-squashed-with-unsound-shm.pdf}
