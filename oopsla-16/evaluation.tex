...
% TODO CAMREADY: Report on SSS-MC-Shared-Mem's mutex testing results.
...
\revisionz{QS-LHB found 69 data-race bugs in total, 54} of which could be found with single-pass data-race candidates alone.
