...
% TODO: if you need, you can recover a line of text by abbreviating "HB".
\revision{
...
as shown in the example program in Figure~\ref{fig:hb-example}(a). % TODO
...
However, consider the similar program in Figure~\ref{fig:hb-example}(b), % TODO
...
and reporting to the user only of directly observed failures.
