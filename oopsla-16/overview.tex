...
% TODO CAMREADY: put another line break here
\\
\revision{
\begin{tabular}{rll}
	%& \multicolumn{2}{c}{\texttt{int x = 0; bool y = false; mutex\_t mx;}} \\
...
\revision{
	...
	Most prior work focuses on {\em Happens-Before} (HB) \cite{lamport-clocks} as the order relation between accesses.
...
%However,
This work incorporates data-race analysis in an internal feedback loop,
