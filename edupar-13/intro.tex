...
Finally, in another two-week project, students implement a small extension to their Pebbles kernel. This project changes every semester, and in the past has included extending their kernel serve as a hypervisor, or to support symmetric multiprocessing.
