...
Of course, additional decision points are necessary to expose more subtle race conditions. We provide an interface for refining the state space, described in Section~\ref{sec:decision}.
