...
Figure~\ref{fig:threadfork} shows a timer-dependent bug common in many Pebbles implementations which we will use as a running example in the rest of this section.
...
Searching with few decision points results in coarser-grained interleavings, shorter test execution, and less likelihood of finding unexpected bugs; searching with more results in the opposite.
