...
%
Of course, due to the nondeterministic nature of many common bugs in student code, these tests can only provide a rough estimate of a submission's correctness, rather than verifying it with certainty.
...
Students who pass the hurdle turn in their kernels and move on to the shorter ``Pebbles Extension'' project.
