...
%
\sortversion{The}{Due to the foundational nature of kernel code, the}
...
\shortversion{}{``the right basic idea''}
...
user-space programs.
The \shortversion{}{library} specification is essentially a stripped-down
