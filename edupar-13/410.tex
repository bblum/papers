...
Simics~\cite{Magnusson:2002:SFS:619072.621909},
...
\item[x86] Students write code that runs on one specific
hardware platform.
...
\item[32-bit] The course still targets the 32-bit
...
\item[memory model] At present we allow students
...
% primeval Unix model: fork()/exec()/wait()
% Mach ``task/thread'' terminology/structure (as opposed to rfork()/clone())
...
% swexn - what an auto-growing stack really means
