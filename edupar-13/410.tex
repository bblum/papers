...
This project
\shortversion{}{meets a variety of goals: it}
...
\shortversion{}{using a combination of}
\x{printf()} and \x{gdb}).
...
and booted via GRUB.
If the \shortversion{}{floppy-disk} image is copied to a real floppy
...
\shortversion{}{The handout for the thread library project itself
...
\shortversion{}{the execution of} user-space threads created by
...
\shortversion{}{from the point of view of OS students,}
...
\shortversion{}{Finally, since it is impossible for an x86 processor
...
students do not \violence{}{have the opportunity to}
...
For these reasons, \shortversion{}{we believe} much of the learning
