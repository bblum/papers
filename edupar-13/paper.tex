...
and discuss what our students are able to achieve in this framework.

However, we also plan to expand the scope of these time-limited projects to match the growing trends of complex memory semantics and massive multicore in modern processors.
For this to be feasible, we hope to reduce the time students need to spend debugging
by introducing new testing tools.
To this end, we present Landslide, a systematic testing tool which offers a more principled approach than stress testing for finding concurrency errors.
...
\begin{IEEEkeywords}
landslide terminal, ground transportation, baggage claim, ticketing
