...
including out-of-order memory semantics and massivly multi-core systems.
For this to be feasible, we wish to reduce the time students spend
debugging concurrency errors.
To this end, we present Landslide, a systematic testing tool which
