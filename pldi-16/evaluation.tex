...
and \numpintoses~``Pintos'' student kernels, from Berkeley's CS162 and University of Chicago's CS230 operating systems classes.
%
...
To show that Iterative Deepening is effective even for MC testing domains without data races, %such as message-passing distributed systems,
