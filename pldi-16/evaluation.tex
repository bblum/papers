...
% TODO: Move this paragraph up into evaluation; this section should only talk about PROBLEMS FROM THE FUTURE
...
the superset state spaces we run later are guaranteed to repeat each branch of their already-completed subsets.
Among completed state spaces across our test suite, the proportion of repeated work was {\bf \large 999\%}.
