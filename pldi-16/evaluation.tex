...
The left half of Table~\ref{tab:drbugs} breaks down the number and types of bugs found by each test case.
...
% TODO: Make a CDF graph of how many tests got total verification here.
...
% TODO: You should introduce this in the narrative as a key contribution way earlier.
...
%Prior work data-race tools \cite{portend} could be configured to have the same sort of feedback loop as Iterative Deepening,
