...
deciding on-the-fly whether to pursue each resulting state space or, or to defer it in favour of smaller ones.
...
If $A$ and $B$ bug-free, they will in turn add $AB$ later.
...
\end{lemma}
% TODO: Put a figure here giving an example of where a data race is only transitively reachable, not initially reachable.
