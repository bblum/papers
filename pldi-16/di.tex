...
Note that while replay-oriented data race tools can already classify free-re-malloc candidates as false positives % benign? (not benign. they are ghosts. not even real.)
