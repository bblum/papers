...
% XXX: Handwave. This neglects the possiblity that TWO necessariy sites of interleaving are as such, and that they are dependent (both preemptions must occur before either data race can be identified).
% TODO: Prove that there must exist one single transition with next paragraph's property, without needing to preempt on any other such transition.
